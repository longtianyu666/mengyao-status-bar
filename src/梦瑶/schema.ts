export const Schema = z.object({
  ...
  资金: z.object({
    ...
    目标金额: z.coerce.number().transform(v => _.clamp(v, 0, 999999)).prefault(500000),
  ...
  哥哥: z.object({
    ...
    已拼部位: z.object({
      ...
      声线: z.coerce.number().transform(v => _.clamp(v, 0, 1)).prefault(0),
      ...
      双腿: z.coerce.number().transform(v => _.clamp(v, 0, 1)).prefault(1),
    ...
    暴露风险: z.coerce.number().transform(v => _.clamp(v, 0, 100)).prefault(8),
  }).prefault({}),
  妹妹: z.object({
